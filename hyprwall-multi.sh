...
show_help() {
    echo "WallPin Multi-Monitor for Hyprland"
    echo "Usage: $0 [command] [options]"
    echo ""
    echo "Commands:"
    echo "  start [monitor] [-f fps] [-s speed] [-c mode] [-t tolerance]   - Start on a specific monitor"
    echo "  start-all [-f fps] [-s speed] [-c mode] [-t tolerance]         - Start on all monitors"
    echo "  stop [monitor]                                                 - Stop wallpaper on a specific monitor"
    echo "  stop-all                                                       - Stop all wallpapers"
    echo "  restart [monitor] [-f fps] [-s speed] [-c mode] [-t tolerance] - Restart on a specific monitor"
    echo "  restart-all [-f fps] [-s speed] [-c mode] [-t tolerance]       - Restart on all monitors"
    echo "  status                                                         - Show the status of all monitors"
    echo "  list-monitors                                                  - List available monitors"
    echo ""
    echo "Options:"
    echo "  -f, --fps [30-500]               - Set FPS (default: 60)"
    echo "  -s, --speed [1.0-100.0]          - Set speed in px/s (default: 18.0)"
    echo "  -c, --color-mode [1-5]           - Color organization mode (default: 1)"
    echo "  -t, --color-tolerance [10-100]   - Color tolerance (default: 50)"
    echo ""
    echo "Color Modes:"
    echo "  1 - Normal (no color grouping)"
    echo "  2 - By dominant color"
    echo "  3 - By color palette"
    echo "  4 - By hue"
    echo "  5 - By temperature (warm/cool)"
    echo ""
    echo "Popular FPS Options:"
    echo "  60    - Standard (default)"
    echo "  120   - Smooth gaming"
    echo "  144   - High-end gaming"
    echo "  240   - Professional gaming"
    echo "  360   - Maximum performance"
    echo ""
    echo "Speed Options (px/s):"
    echo "  10.0  - Slow and relaxing"
    echo "  18.0  - Normal (default)"
    echo "  25.0  - Fast"
    echo "  35.0  - Very fast"
    echo ""
    echo "Color Tolerance:"
    echo "  30    - Strict (more specific groups)"
    echo "  50    - Normal (default)"
    echo "  70    - Lenient (broader groups)"
    echo ""
    echo "Examples:"
    echo "  $0 start HDMI-A-1 -f 120 -s 25.0        # 120 FPS, fast speed on HDMI"
    echo "  $0 start eDP-1 -f 144 -s 10.0           # 144 FPS, slow speed on laptop"
    echo "  $0 start-all -f 60 -s 18.0              # 60 FPS, normal speed on all monitors"
    echo "  $0 restart-all -f 240 -s 30.0           # Restart all with 240 FPS and high speed"
    echo "  $0 start HDMI-A-1 -c 2 -t 60            # Dominant color mode, tolerance 60"
    echo "  $0 start-all -c 4 -t 30 -f 120          # Hue mode, strict tolerance, 120 FPS"
    echo "  $0 start HDMI-A-1 120 25.0              # Also supports positional syntax"
    echo ""
}
